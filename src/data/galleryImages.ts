...
export const galleryImages: GalleryImage[] = [
  ...
  {
    id: "recording-by-the-winter-window",
    src: "/images/gallery/recording-by-the-winter-window.jpg",
    alt: "The view from behind a camera on a tripod, its screen showing a woman in a black turtleneck and glasses mid-recording, while beyond it two people sit talking by tall windows with snow-laden trees outside",
    caption: "Recording by the winter window",
    featuredOnHome: false,
    order: 170,
    width: 1536,
    height: 2048,
  ...
  {
    id: "viewfinder-green-sofa",
    src: "/images/gallery/viewfinder-green-sofa.jpg",
    alt: "A camera screen framing a guest in a white off-shoulder blouse, with the host and guest seated on a green sectional against a white brick wall behind it, dark red flowers and pink candles on the table",
    caption: "The frame the camera keeps",
    featuredOnHome: false,
    order: 180,
    width: 1536,
    height: 2048,
  ...
  {
    id: "mid-sentence-on-set",
    src: "/images/gallery/mid-sentence-on-set.jpg",
    alt: "A guest in a taupe sweater gesturing mid-sentence towards the host on a green sofa, an LED panel and softbox lighting the white brick room as low sun falls across the floor",
    caption: "Mid-sentence, mid-take",
    featuredOnHome: false,
    order: 190,
    width: 1536,
    height: 2048,
  ...
  {
    id: "two-seats-one-camera",
    src: "/images/gallery/two-seats-one-camera.jpg",
    alt: "A guest in a headscarf and the host with a laptop seated at opposite ends of a green sectional, a houseplant throwing its shadow across the white brick wall behind them",
    caption: "Two seats, one camera",
    featuredOnHome: false,
    order: 200,
    width: 1536,
    height: 2048,
