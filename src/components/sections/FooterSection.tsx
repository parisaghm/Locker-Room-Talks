...
const FooterSection = () => {
  return (
    <footer id="footer" className="bg-[#1a1a1a] text-gray-200 py-16 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Separator Line */}
        <div className="h-px bg-gray-300/30 mb-12 max-w-2xl mx-auto"></div>
