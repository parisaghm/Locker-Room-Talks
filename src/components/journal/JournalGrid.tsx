...
const JournalGrid = ({ articles, activeCategory }: JournalGridProps) => {
  ...
  return (
    <div
      ...
      key={activeCategory}
      className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-8 lg:gap-x-12 gap-y-12 sm:gap-y-16 animate-in fade-in duration-500 motion-reduce:animate-none"
    >
